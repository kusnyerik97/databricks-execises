...
from pyspark.sql.types import StructType, StringType, IntegerType, TimestampType, DoubleType, StructField, DateType
...
#df1=gamingEventDF.select(to_date(gamingEventDF.eventParams.client_event_time).alias('eventDate'))
#df1=gamingEventDF.withColumn('eventParams.client_event_time',col('eventParams')["client_event_time"].cast("Date"))
#df1=gamingEventDF.withColumn("eventParams.client_event_time",gamingEventDF['eventParams.client_event_time'].cast("Date")).printSchema()
#df1 = gamingEventDF.withColumn('eventParams', struct(*[col('eventParams')['client_event_time'].alias('client_event_time'), ]))
...
#    .withColumn(eventParams)
 #   .filter(col(eventParams)
